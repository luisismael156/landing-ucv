...
<head>
    ...
    <style>
        ...
        #banner {
            ...
            background-image: url(img/banner-psicologia.png);
    ...
    top: 115px;
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
               background-image: url(img/banner-mobile-psicologia.png);
                background-size: cover;
                height: 546px;
            ...
            <div class="row ">
                <div class="col-lg-7 bg-banner">
                    ...
                    <div class="box-title-banner">
                        <h1 class="text-white font-roboto title-ba-one pb-2">Psicología</h1>
                        <h5 class="title-ba text-white">Y orienta a las personas a construir relaciones positivas.</h5>
                    </div>
                        ...
                        <div class="tab-content content-form" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="landing" value="Psigología - Descarga">
                            ...
                            <div class="tab-pane fade show" id="pills-profile" role="tabpanel"
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="landing" value="Psigología - Test">
                                    <input type="hidden" name="source" value="<?php echo $source;?>" />
                                    <input type="hidden" name="url" value="<?php echo $url;?>" />
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="condicion" required>
