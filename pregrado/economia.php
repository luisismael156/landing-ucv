...
<head>
    ...
    <title>UCV .::. Economía</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-economia.png?v=4);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-economia-mobile.png?v=4);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one one-line pb-2">Economía</h1>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Economia" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Utiliza eficientemente los recursos de las organizaciones con una visión más integral, interpretando información que pocos entiendan y contribuyendo a la toma de decisiones, aprendiendo a crear soluciones que sirvan para el futuro de los negocios.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar <br>Economía
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Simulador Eviews: Administra datos y realiza análisis estadísticos</li>
                                        <li>Software SPSS. Crea matrices de datos, identifica tendencias y realiza predicciones.</li>
                                        <li>Analiza el flujo de ingreso de las organizaciones y haz crecer su rentabilidad económica.</li>
                                    </ul>
                        </div>
                    </div>
