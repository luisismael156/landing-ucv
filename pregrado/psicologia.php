...
<head>
    ...
    <title>UCV .::. Psicología</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-psicologia.png?v=5);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-psicologia-mobile.png?v=5);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one one-line pb-2">Psicología</h1>
                                <h5 class="title-ba text-white">y sé gestor de programas psicológicos personales, familiares y de comunidad.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Psicología" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Desarrolla tus habilidades para orientar a las personas a construir relaciones afectivas con los demás y con ellas mismas. Es tiempo de desarrollar tu pasión por el autodescubrimiento.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex mb-3 ">Razones para<br> estudiar Psicología<br>
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Planifica, ejecuta y evalúa programas de promoción y prevención psicológica centrados en la persona, familia y comunidad.</li>
                                        <li>Formula, implementa, evalúa y sustenta proyectos e informes de investigación, para contribuir con el avance de la psicología y con el desarrollo de la sociedad.</li>
                                        <li>Elabora, ejecuta proyectos para el desarrollo organizacional, a fin de mejorar la productividad.</li>
                                        <li>Laboratorio de Neurociencias. Descubre las herramientas necesarias para conocer el sistema nervioso. </li>
                                    </ul>
                        </div>
                    </div>
