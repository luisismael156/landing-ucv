...
<head>
    ...
    <title>UCV .::. Arte y Diseño Gráfico Empresarial</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-arte.png?v=2);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-arte-mobile.png?v=2);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one pb-2">Arte & Diseño <br>Gráfico Empresarial</h1>
                                <h5 class="title-ba text-white">y crea un nuevo lenguaje visual para el mundo empresarial.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Arte & Diseño Grafico Empresarial" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Aprende a crear y producir productos o servicios que transmitan emociones generadoras de una buena experiencia en las personas. Crea un lenguaje visual y estratégico para convertir tus ideas en mensajes entendibles y potentes.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar Arte <br>
                         y Diseño Gráfico Empresarial en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Produce mensajes visuales con significados semióticos estéticamente adecuados.</li>
                                        <li>Ejecuta proyectos para desarrollar discursos editoriales con una visión plural de la realidad</li>
                                        <li>Detecta oportunidades y crea propuestas innovadoras y significativas para el mercado.</li>
                                        <li>Taller de serigrafía.</li>
                                    </ul>
                        </div>
                    </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Colombia: Universidad Antonio José Camacho</li>
                                        <li>Colombia: Universidad de Investigación y Desarrollo</li>
