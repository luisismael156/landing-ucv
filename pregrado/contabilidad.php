...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                ...
                                <h5 class="title-ba text-white">y desarrolla grandes proyectos de inversión y desarrollo social.
                                </h5>
                            </div>
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Desarrollarás tus habilidades gerenciales para convertirte en un contador público indispensable para el rubro que trabajes. Manejarás estratégicamente la información financiera de las empresas contribuyendo con su desarrollo.</h5>
                </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Simulador SISCONT: Desarróllate en la gestión de créditos y cobranzas, control de presupuestos y centros de costos.</li>
                                        <li>Evalúa el control interno, la razonabilidad de los estados financieros y la gestión para generar valor en las organizaciones.</li>
                                    </ul>
                        </div>
                    </div>
