...
<head>
    ...
    <title>UCV .::. Ingenier&iacute;a Mecánica Eléctrica</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-mecanicaelectrica.png);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-mecanicaelectrica-mobile.png);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                ...
                                Mecánica Eléctrica<br></h1>
                                <h5 class="title-ba text-white">Y domina el uso eficiente de la energía eléctrica. 
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Ing. Mecanica" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Desarrolla soluciones en base a tecnologías o diseño de mecanismos, mejorando los procesos productivos de las empresas. Descubre tus capacidades para impulsar empresas con responsabilidad social y ambiental.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    Mecánica Eléctrica<br> en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Diseña y ejecuta eficientemente procesos de generación, transmisión, distribución y utilización eficiente de energía eléctrica a partir de fuentes renovables de energía.</li>
                                        <li>Diseña y fabrica equipos industriales, sistemas electromecánicos y estructuras metálicas con creatividad, innovación y trabajo en equipo.</li>
                                        <li>Simuladores: PASCO E-BOOK FÍSICA, MATLAB, FESTO LVSIM, ANSYS y SWORK.</li>
                                        <li>Laboratorio de control y automatización.</li>
                                    </ul>
                        </div>
                    </div>
