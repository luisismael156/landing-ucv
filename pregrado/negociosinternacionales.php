...
<head>
    ...
    <title>UCV .::. Negocios Internacionales</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-negocios.png?v=5);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-negocios-mobile.png?v=5);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one  pb-2">Negocios<br> Internacionales</h1>
                                <h5 class="title-ba text-white">y prepárate para gestar y evaluar grandes proyectos de inversión internacional.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Negocios Internacionales" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Prepárate para conocer cómo funciona el mercado global, la economía y el contexto mundial, detecta las oportunidades de negocio que pueden unificar mercados y se adapten a diferentes puntos de vista. Entiende el comercio internacional y conviértete en un ciudadano del mundo.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar Negocios Internacionales
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>El Simulador de Inteligencia Comercial Internacional: Aprende a realizar un análisis de la competencia.</li>
                                        <li>El Simulador Aduanero SOFTPAD. Para solicitar cotización de los servicios aduaneros y logísticos.</li>
                                        <li>Aprende a evaluar la información financiera para la toma de decisiones en las operaciones de negocios internacionales.</li>
                                        <li>Crea estrategias de logística internacional para la oferta exportable, optimizando costos y tiempos de entrega con criterio lógico y responsabilidad.</li>
                                    </ul>
                        </div>
                    </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Estados Unidos: Michigan State University</li>
