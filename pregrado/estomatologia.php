...
<head>
    ...
    <title>UCV .::. Estomatología</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-estomatologia.png?v=4);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-estomatologia-mobile.png?v=4);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one one-line pb-2">Estomatología</h1>
                                <h5 class="title-ba text-white">y refleja el bienestar integral en una sonrisa.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Estomatología" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Desarrolla tu potencial para proteger la salud bucal y dental de cientos de personas logrando que muestren su mejor sonrisa al mundo. Consigue las habilidades necesarias para diagnosticar, prevenir y tratar enfermedades bucodentales.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar Estomatología<br>
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Diagnostica la salud y las enfermedades prevalentes del sistema estomatognático.</li>
                                        <li>Simuladores Lecturio. </li>
                                        <li>Clínica estomatológica.</li>
                                        <li>Laboratorio de rayos x.</li>
                                        <li>Laboratorio de prótesis, anatomía, biología, microbiología, parasitología, clínico, bioquímica y farmacología.</li>
                                    </ul>
                        </div>
                    </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Taiwán: Providence University</li>
                                        <li>Colombia: Universidad Cooperativa de Colombia</li>
                                        <li>Colombia: Universidad de Boyaca</li>
                                        <li>Argentina: Universidad Nacional de Litoral </li>
                                        <li>Brasil: Universidad Federal Fluminense</li>
