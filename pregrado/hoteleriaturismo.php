...
<head>
    ...
    <style>
        #banner {
            background-image: url(assets/img/banner-turismo.png?v=4);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-turismo-mobile.png?v=4);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one pb-2">Administración<br> en Turismo y<br> Hotelería</h1>
                                <h5 class="title-ba text-white">y crea proyectos de desarrollo turístico nacionales e internacionales.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Administración en Turismo y Hotelería" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Aprende a crear experiencias memorables y demuestra que el mundo es más grande de lo que parece. Atrévete a ampliar las oportunidades de promover el turismo nacional e internacional, enfocando de una manera estratégica el desarrollo de nuevos proyectos turísticos y explotando su potencial natural y cultural.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar <br>Administración en Turismo y Hotelería
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Taller De Housekeeping. Aprende las técnicas necesarias para un correcto desempeño en el área de ama de llaves.</li>
                                        <li>Taller De Gastronomía y Bar. Aprende las principales técnicas culinarias y de bar.</li>
                                        <li>Simulador SABRE. Aprende las funciones que realiza un ejecutivo de agencia de viajes.</li>
                                        <li>Simulador OPERA. Gestiona las operaciones de un hotel: reservas, recepción, housekeeping y facturación.</li>
                                    </ul>
                        </div>
                    </div>
