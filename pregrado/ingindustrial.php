...
<head>
    ...
    <title>UCV .::. Ingenier&iacute;a Industrial</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-industrial.png);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-industrial-mobile.png);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                ...
                                Industrial <br></h1>
                                <h5 class="title-ba text-white">Y genera estrategias que aseguren el futuro sostenible del país. 
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Ing. Industrial" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Elabora estratégica y eficientemente los procesos de una empresa para optimizar su productividad. Es tiempo de aprender a ser un experto en la automatización y en las industrias con una visión más adelantada. Es tiempo de convertirte en el líder que las empresas necesitan. </h5>
                </div>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Diseña y mejora sistemas de producción de bienes y servicios, buscando la productividad y la eficiencia en los procesos. </li>
                                        <li>Gestiona de manera estratégica y táctica las operaciones relacionadas a la planificación y producción de bienes y servicios.</li>
                                        <li>Diseña sistemas de gestión de la calidad en organizaciones, promoviendo la mejora continua, la cultura de calidad y auditoría.</li>
                                        <li>Simuladores: PASCO E-BOOK FÍSICA, PASCO E-BOOK QUÍMICA, VIRTUAL PLANT.</li>
                                        <li>Laboratorio de Química, Laboratorio de Procesos Industriales, Planta piloto productiva.</li>
                                        <li>Laboratorio de Física, electrónica y ergonomía.</li>
                                        <li>Laboratorio de automatización de procesos.</li>
