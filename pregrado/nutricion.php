...
<head>
    ...
    <title>UCV .::. Nutrición</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-nutricion.png?v=5);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-nutricion-mobile.png?v=5);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one one-line pb-2">Nutrición</h1>
                                <h5 class="title-ba text-white">y promueve estilos de vida saludables.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Nutrición" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Conoce cómo se alimentan las poblaciones y aprende a trabajar por la salud en un espacio interdisciplinario. Logra mejorar los hábitos alimenticios de las personas para poder mejorar el futuro que deseas. </h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex mb-3 ">Razones para<br> estudiar Nutrición<br>
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Convenios en prácticas con MINSA, EsSalud, Municipalidad de la Esperanza y Gimnasios.</li>
                                        <li>Desarrollo de actividades de Responsabilidad Social en los sectores más vulnerables.</li>
                                        <li>Ejecuta actividades preventivas promocionales en Nutrición a fin de contribuir a la mejora del estado nutricional de la población.</li>
                                        <li>Software virtual: LECTURIO y aplicativo móvil.</li>
                                        <li>Laboratorio de Evaluación Nutricional y Consultorio Nutricional.</li>
                                        <li>Laboratorio de Tecnología de Alimentos.</li>
                                        <li>Implementación del laboratorio de Bromatología.</li>
                                    </ul>
                        </div>
                    </div>
