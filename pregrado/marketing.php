...
<head>
    ...
    <title>UCV .::. Marketing y Dirección de Empresas</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-marketing.png?v=5);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-marketing-mobile.png?v=5);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one  pb-2">Marketing y <br>Dirección de<br> Empresas</h1>
                                <h5 class="title-ba text-white">y realiza análisis financieros en proyectos de inversión internacional.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Marketing y Dirección de Empresas" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Identifica la lógica de los consumidores, analiza el rumbo de las marcas y atrévete a proponer nuevas oportunidades de negocios. Esta carrera te formará con una gran visión comercial, con capacidad para liderar proyectos y transformar lo racional en emocional. </h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar Marketing y Dirección de Empresas
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Sala Gesell. Sala para la investigación cualitativa de mercados, focus group y entrevistas de profundidad.</li>
                                        <li>Taller de marketing digital. Diseña estrategias de marketing digital como complemento a las estrategias offline para contribuir a la generación de rentabilidad en las organizaciones.</li>
                                        <li>Taller de E-business. Crea estrategias de marketing para negocios virtuales, intranets y sitios web sociales.</li>
                                    </ul>
                        </div>
                    </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Argentina: Universidad Nacional de Tucuman</li>
                                        <li>Argentina: Universidad de la Cuenca del Plata</li>
                                        <li>Argentina: Universidad Nacional del Litoral</li>
                                        <li>México: Universidad de Guadalajara</li>
                                        <li>México: Universidad Autónoma del Estado de México</li>
                                        <li>México: Universidad de Celaya</li>
                                        <li>España: Universidad de Oviedo</li>
                                        <li>Colombia: Universidad de Mariana</li>
                                        <li>Brasil: Centro Universitario Alvares Penteado</li>
