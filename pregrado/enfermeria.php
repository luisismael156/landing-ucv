...
<head>
    ...
    <title>UCV .::. Enfermería</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-enfermeria.png?v=4);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-enfermeria-mobile.png?v=4);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                <h1 class="text-white font-roboto title-ba-one one-line pb-2">Enfermería</h1>
                                <h5 class="title-ba text-white">y lidera equipos que entrenan enfermeros en diversos centros de salud.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Enfermería" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Aprende a proteger la salud de las personas y brindar mejores condiciones de vida para ellos. Vive una carrera que, además de ser tu vocación, es tu compromiso con las personas y el cuidado oportuno de tu comunidad.</h5>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-5 b-bottom">
                    ...
                    <h1 class="title-block d-flex   mb-3 ">Razones para<br> estudiar Enfermería<br>
                        en la UCV
                           </h1>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Administra los servicios de salud públicos, privados y otros para mejorar la calidad de atención y gestiona el cuidado de enfermería.</li>
                                        <li>Educa a la persona, familia, comunidad para promover estilos de vida saludables.</li>
                                        <li>Simulador para el cuidado del paciente geriátrico.</li>
                                        <li>Simuladores ginecológicos de cateterización.</li>
                                        <li>Simuladores virtuales: Body interact y VSIM.</li>
                                        <li>Laboratorio de Enfermería Fundamental.</li>
                                    </ul>
                        </div>
                    </div>
                            ...
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        ...
                                        <li>Rusia: Universidad Federal de Kazán</li>
