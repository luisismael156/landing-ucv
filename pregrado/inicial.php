...
<head>
    ...
    <title>UCV .::. Educación Inicial</title>

    <style>
        #banner {
            background-image: url(assets/img/banner-inicial.png);
        ...
        @media (max-width: 575px) {
            ...
            .bg-banner {
                background-image: url(assets/img/banner-inicial-mobile.png);
                background-size: cover;
                height: 546px;
...
<?php 
                ...
                <div class="col-md-12">
                    ...
                    <div class="barra-bottom"></div>
                            <div class="box-title-banner wow animate__animated animate__fadeIn">
                                ...
                                Inicial <br></h1>
                                <h5 class="title-ba text-white">y crea innovadoras metodologías de aprendizaje.
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-5 no-p wow animate__animated animate__fadeIn">
                            ...
                            <div id="form-banner">
                                ...
                                <form id="formu" class="d-block" action="enviar.php" method="post">
                                    ...
                                    <input type="hidden" name="carrera" value="Educ. Inicial" />
    ...
    <section id="descripcion-carrera" class="l-container">
        ...
        <div class="row justify-content-center">
                <div class="col-md-10">
                    <h5 class="descripcion-carrera wow animate__animated animate__fadeInUp">Transforma las formas de enseñanza en tu pasión.  Genera nuevas propuestas de aprendizaje que sean originales y didácticas para desarrollar el potencial de los niños y garantizar su crecimiento y una fuerte autoestima.</h5>
                </div>
                ...
                <div class="col-md-5 b-bottom">
                            <div class="block-left">
                                <div class="block-list wow animate__animated animate__fadeInUp">
                                    <ul>
                                        <li>Centro de estimulación temprana. Fomenta en los niños de 2 y 3 años la investigación científica, poniendo a prueba su curiosidad por medio del juego.</li>
                                        <li>Doble titulación en la Universidad de Perugia de Italia.</li>
                                        <li>Diseña programas educativos innovadores para mejorar la realidad educativa.</li>
                                    </ul>
                        </div>
                    </div>
